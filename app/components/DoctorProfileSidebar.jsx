    ...
    <aside className='h-[100vh] fixed w-[250px] border-r-[1px] border-r-solid border-r-grey flex flex-col items-start gap-24'>
        <div className='w-full flex flex-col items-center justify-center gap-3'>
          ...
          <div className='flex flex-col items-center justify-center gap-2'>
            ...
            <p className='grey_text'>Doctor</p>
          </div>
        </div>
        <div className='w-full flex flex-col items-start'>
          <Link href='/pages/doctor/profile' className='w-full' passHref>
            <div className={`p-4 border-y-[1px] border-y-solid border-y-grey w-full ${
              active === '/pages/doctor/profile' ? 'active-link' : ''
            }`}
            role='button'
            tabIndex='0'>
          ...
          <Link href='/pages/doctor/profile/security' className='w-full' passHref>
          <div className={`p-4 border-y-[1px] border-y-solid border-y-grey w-full ${
              active === '/pages/doctor/profile/security' ? 'active-link' : ''
            }`}
            role='button'
            tabIndex='0'>
          ...
          <Link href='/pages/doctor/profile/settings' className='w-full' passHref>
          <div className={`p-4 border-y-[1px] border-y-solid border-y-grey w-full ${
              active === '/pages/doctor/profile/settings' ? 'active-link' : ''
            }`}
            role='button'
            tabIndex='0'>
