    ...
    <aside className='h-[100vh] fixed w-[250px] border-r-[1px] border-r-solid border-r-grey flex flex-col items-start gap-24'>
        <div className='w-full flex flex-col items-center justify-center gap-3'>
          ...
          <div className='flex flex-col items-center justify-center gap-2'>
            ...
            <p className='grey_text'>Admin</p>
          </div>
        </div>
        <div className='w-full flex flex-col items-start'>
          <Link href='/pages/admin/profile' className='w-full' passHref>
            <div className={`p-4 border-y-[1px] border-y-solid border-y-grey w-full ${
              active === '/pages/admin/profile' ? 'active-link' : ''
            }`}
            role='button'
            tabIndex='0'>
          ...
          <Link href='/pages/admin/profile/security' className='w-full' passHref>
          <div className={`p-4 border-y-[1px] border-y-solid border-y-grey w-full ${
              active === '/pages/admin/profile/security' ? 'active-link' : ''
            }`}
            role='button'
            tabIndex='0'>
          ...
          <Link href='/pages/admin/profile/settings' className='w-full' passHref>
          <div className={`p-4 border-y-[1px] border-y-solid border-y-grey w-full ${
              active === '/pages/admin/profile/settings' ? 'active-link' : ''
            }`}
            role='button'
            tabIndex='0'>
              <p className='small_text'>Admin Settings</p>
            </div>
          </Link>
        </div>
      </aside>
